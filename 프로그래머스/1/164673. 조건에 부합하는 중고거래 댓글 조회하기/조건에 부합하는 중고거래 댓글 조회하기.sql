...
LEFT join USED_GOODS_REPLY on USED_GOODS_BOARD.BOARD_ID = USED_GOODS_REPLY.BOARD_ID
where USED_GOODS_REPLY.WRITER_ID is not null and DATE_FORMAT(USED_GOODS_BOARD.CREATED_DATE,'%Y-%m') = '2022-10'
